 ...
 * @author helio
 */
public class DashboardEmployees extends javax.swing.JFrame {

    /**
     * Creates new form DashboardAdmin
     */
    public DashboardEmployees() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardEmployees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardEmployees().setVisible(true);
            }
        });
    }
