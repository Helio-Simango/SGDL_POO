 ...
 * @author helio
 */
public class RegistarCardapio extends javax.swing.JDialog {

    
    private ProdutosPanel produtosPanel;
    /**
     * Creates new form RegistarCardapio
     */
    public RegistarCardapio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registar Cardapio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistarCardapio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegistarCardapio dialog = new RegistarCardapio(new javax.swing.JFrame(), true);
